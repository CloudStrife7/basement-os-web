---
name: devlog
description: Create a new devlog entry using an interactive interview process. Use when the user wants to write a devlog, blog post, or document their development progress.
---
