...
public class DT_App_Games : UdonSharpBehaviour
{
    ...
    [SerializeField] private string[] gameNames = new string[] { "PONG", "SNAKE", "TETRIS" };

    [Tooltip("One-line descriptions")]
    [SerializeField] private string[] gameDescriptions = new string[] { "Classic Paddle Game", "Slithering Fun", "Block Stacking" };

    [Tooltip("Which games are playable")]
    [SerializeField] private bool[] gameEnabled = new bool[] { true, true, false };
