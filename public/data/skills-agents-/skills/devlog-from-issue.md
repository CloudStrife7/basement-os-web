---
name: devlog-from-issue
description: Publish a devlog post using GitHub Issues workflow. Use when user mentions GitHub issues for devlog, or wants to publish via issue template.
---
